...
public class HelloConsumer {
    ...
    private HelloConsumer(String streamName, String region) {
        this.streamName = streamName;
        this.region = Region.of(ObjectUtils.firstNonNull(region, "ap-south-1"));
    ...
    public static void main(String... args) {
        ...
        System.out.println("Stream Name =>"+streamName+", Region =>"+region);
        new HelloConsumer(streamName, region).run();
    }
